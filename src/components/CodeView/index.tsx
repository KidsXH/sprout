...
export const CodeView = () => {
  return (
    <div className='flex flex-col w-2/5 m-1 text-left bg-white p-1'>
      <div className='flex text-xl font-bold p-1 h-12 text-neutral-600 items-center select-none'>Code View</div>
