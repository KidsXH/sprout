...
export const CodeView = () => {
  return (
    <div className='flex flex-col m-1 text-left bg-white p-1'>
      <div className='flex w-[28rem] text-xl font-bold p-1 h-12 text-neutral-600 items-center select-none'>Code View</div>
