...
function calcNodeRadius(
  ...
  if (contentString.length >= longestContentLength) {
    ...
    return ((contentString.length - shortestContentLength) / longestContentLength) * maxRadius + minRadius;
  }
}
...
export const SpaceView = () => {
  ...
  //     if (shortestContentLength == -1 || value.action.content.length < shortestContentLength) {
  //       shortestContentLength = value.action.content.length;
  //     }
  //     if (longestContentLength == -1 || value.action.content.length > longestContentLength) {
  ...
  //   const dotData = getCoordinates(contentArray, apiKey).then(
  //     (res) => {
  //       if (!res) {
  //         return
  //       }
